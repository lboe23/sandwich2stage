#' Example Dataset: sandwichdata_SRS
#'
#' This sample data set was simulated to create variables
#' that are similar to ones we might see in a real cohort
#' study where we want to apply the 2-stage regression
#' approach of regression calibration.
#' We use this data set to generate the workflow in the
#' main package vignette for the simple random sample case.
#'
#' See package vignettes for more details.
#'
#' @docType data
#'
#' @name sandwichdata_SRS
#' @format \code{sandwichdata_SRS:} a data frame with 10000 rows and 9 columns
#' \describe{
